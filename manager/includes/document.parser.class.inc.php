...
//                if($pos) $tag = substr($tag,0,$pos);
    ...
    private function _snipParamsToArray($string = '') {
    ...
    private function _findSplitter($str) {
        $str = str_split($str);
        $pass = false;
        $i = -1;
        $pos = false;
    ...
    */
    ...
    function getUserDocGroups($resolveIds = false) {
        ...
        if (isset($_SESSION['mgrDocgroups'])
                && !empty($_SESSION['mgrDocgroups'])
